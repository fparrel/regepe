...
<div id="map_list">Loading...<img src="/images/loading.svg" width="32" height="32"/></div>
</div>
</body>
</html>
	...
	if (this.readyState == 4) {
		if (this.status == 200) {
            ...
            for (i=0;i<map_list.length;i++) {
                ...
                map_list_contents += '<tr><td>'+map_list[i].startdate+'</td><td><a href="showmap-flot.php?mapid='+map_list[i].mapid+'"/>'+map_list[i].desc+'</a></td><td><img src="thumbnail.php?mapid='+map_list[i].mapid+'" width="130" height="110"/></td></tr>';
            }
