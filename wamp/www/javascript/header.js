...
function onSearchClick() {
    ...
    if (trim(search_req).length>0) {
        ...
        client.open('GET','/cgi-bin/search.py?search_req='+
        ...
        document.getElementById("header_search").innerHTML = 'Searching... <img src="/images/loading.svg" width="16" height="16"/>';
    }
}
	...
	if (this.readyState == 4) {
		if (this.status == 200) {
            ...
            for (i=0;i<maps.length;i++) {
                ...
                map_list_contents = map_list_contents + '<tr><td>'+startdate+'</td><td><a href="showmap-flot.php?mapid='+mapid+'"/>'+desc+'</a></td><td>'+user+'</td><td><img src="thumbnail.php?mapid='+mapid+'" width="130" height="110"/></td></tr>';
            }
...
function doCheckSessionServer(user,sess) {
    var client = new XMLHttpRequest();
    client.open('GET','/cgi-bin/dochksess.py?user='+
    ...
    document.getElementById("header_login").innerHTML = 'Login... <img src="/images/loading.svg" width="16" height="16"/>';
}

function onLoginClick() {
    var client = new XMLHttpRequest();
    client.open('GET','/cgi-bin/dologin.py?user='+
