...
function initGeoportalMap() {
	...
	if (VISU.getMap().allowedGeoportalLayers) {
		...
		sel_icon = {externalGraphic:'../images/MarkerStart.png',  graphicWidth:12, graphicHeight:20, graphicXOffset:-6, graphicYOffset:-20};
		pt_icon = {externalGraphic:'../images/MarkerSelBegin.png',  graphicWidth:12, graphicHeight:20, graphicXOffset:-6, graphicYOffset:-20};
