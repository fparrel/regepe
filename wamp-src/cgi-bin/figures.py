...
class Figures:
    ...
    def computeMaxSpeedsOld(self,fromspd=True):
        ...
        for i in range(0,len(self.trkseg.ptlist)):
            ...
            # Compute max speeds over distances
            ...
            if not options['flat']:
                ...
                # Compute max vert speed over distances
                ...
                # Compute max vert speed over time
                for maxspds_idx in range(0,len(maxspdstime_vert)):
