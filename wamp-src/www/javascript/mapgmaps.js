...
function addBuoyMarker() {
    if (typeof buoy_marker=='undefined') {
        var buoy_icon = "../images/MarkerBuoy.png";
...
var icon_start = {url: "../images/MarkerStart.png", size: {width: 12, height: 20}, anchor: {x: 6, y: 20}};
var icon_end = {url: "../images/MarkerEnd.png", size: {width: 12, height: 20}, anchor: {x: 6, y: 20}};
//var selbegin_icon = {url: "../images/MarkerSelBegin.png", size: {width: 12, height: 20}, anchor: {x: 6, y: 20}};
//var selend_icon = {url: "../images/MarkerSelEnd.png", size: {width: 12, height: 20}, anchor: {x: 6, y: 20}};
var selbegin_icon = "../images/MarkerSelBegin.png";
var selend_icon = "../images/MarkerSelEnd.png";
