...
function initGeoportalMap() {
	...
	if (VISU.getMap().allowedGeoportalLayers) {
        ...
        */
		...
		start_icon = {externalGraphic:'../images/MarkerStart.png',  graphicWidth:12, graphicHeight:20, graphicXOffset:-6, graphicYOffset:-20};
		end_icon = {externalGraphic:'../images/MarkerEnd.png',  graphicWidth:12, graphicHeight:20, graphicXOffset:-6, graphicYOffset:-20};
		selbegin_icon = {externalGraphic:'../images/MarkerSelBegin.png',  graphicWidth:12, graphicHeight:20, graphicXOffset:-6, graphicYOffset:-20};
		selend_icon = {externalGraphic:'../images/MarkerSelEnd.png',  graphicWidth:12, graphicHeight:20, graphicXOffset:-6, graphicYOffset:-20};		
		arrow_icons = [];
		for (var angle=0;angle<360;angle += 15) {
			arrow_icons.push({externalGraphic:'../images/Arrow' + angle + '.png',  graphicWidth:15, graphicHeight:15, graphicXOffset:-8, graphicYOffset:-8});
		}
